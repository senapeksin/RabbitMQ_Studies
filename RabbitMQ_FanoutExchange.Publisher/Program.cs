...
// Fanout Exchange Davranışı: Herhangi bir kuyruğu ayırt etmeyeceğimizden dolayı routingKey boş bir değer verebiliriz.. Fanout Exchange, bu exchange' e bind olmuş kuyrukların hepsine isim gözetmeksizin mesajları ileteceği için routingKey boş olmalıdır.
for (int i = 0; i < 100; i++)
{
